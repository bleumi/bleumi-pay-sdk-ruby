  ...
  class WalletInputs
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BleumiPay::WalletInputs` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BleumiPay::WalletInputs`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @wallet_library.nil?
        invalid_properties.push('invalid value for "wallet_library", wallet_library cannot be nil.')
      end

      if @wallet_proxy.nil?
        invalid_properties.push('invalid value for "wallet_proxy", wallet_proxy cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @wallet_library.nil?
      return false if @wallet_proxy.nil?
    ...
    def hash
      [buyer, merchant, wallet_library, wallet_proxy, salt].hash
    end
